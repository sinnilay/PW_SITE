        ...
        <div>
            <div class="flex flex-col mt-12">
               ...
               <span class="flex flex-row  mt-7 ml-2 gap-7">
                  <img class=" w-10" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBeI1qAagHeRyYEhW5yeiv7uwk2i6yRTKjw&s" alt="" />
        ...
        <div>
            <div class="flex flex-col  mt-6 md:mt-12 w-auto ml-2 md:ml-0">
               <p class=" text-2xl  md:text-3xl font-bold text-white ">Company</p>
                <div class=" border-b-4 w-80 h-1 border-orange-300  items-center   md:w-96 md:h-2 md:mt-3 md:border-b-5 rounded-lg mt-4"> 
